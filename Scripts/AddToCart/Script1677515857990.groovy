...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_standard_userlocked_out_userproblem_use_50634e'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/div_standard_userlocked_out_userproblem_use_50634e'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/img_Name (A to Z)_inventory_item_img'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/button_Add to cart'))
