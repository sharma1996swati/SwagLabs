...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/img_Add to cart_inventory_item_img'))

WebUI.verifyTextPresent('', false)

WebUI.verifyTextPresent('', false)

WebUI.rightClick(findTestObject('Object Repository/Page_Swag Labs/a_Twitter'))
