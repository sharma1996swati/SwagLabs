...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/a_1'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'secret')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'sauce')
